 ...
 * @author ramir
 */
public abstract class TicketVista extends javax.swing.JDialog{
    
    protected TicketControlador controlador;
    
    public TicketVista(JFrame jFrame, String text,TicketControlador controlador){
    ...
    public abstract void setTicketId(int ticket_id);
